...
- **2025-01-15**:
  ...
  - Removed Support for controller_entity. ([@yarafie](https://github.com/yarafie))
  - Added Support for Zigbee2MQTT MQTT device triggers. ([@yarafie](https://github.com/yarafie))
